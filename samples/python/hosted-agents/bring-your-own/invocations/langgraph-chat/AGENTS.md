...
azd ai agent invoke --local --protocol invocations "your message" # Test the local agent
azd deploy                                 # Deploy to Foundry
azd ai agent invoke --protocol invocations "your message"         # Invoke the deployed agent
```
